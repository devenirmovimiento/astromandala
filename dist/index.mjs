    ...
    return /* @__PURE__ */ jsxs(
      "g",
      {
        ...
        children: [
          ...
          planet.planet === "Pluto" ? /* @__PURE__ */ jsx(
            PlutoSymbol,
            {
              x: symbolPos.x,
              y: symbolPos.y,
...
function PlanetSymbol({
  ...
  if (planet === "Pluto") {
    ...
    return /* @__PURE__ */ jsx(PlutoSVG, { size: numSize, color });
  }
  return /* @__PURE__ */ jsxs(
    "span",
    {
  ...
  return /* @__PURE__ */ jsxs("div", { style: containerStyle, className, children: [
    ...
    /* @__PURE__ */ jsx("table", { style: { width: "100%", borderCollapse: "collapse" }, children: /* @__PURE__ */ jsx("tbody", { children: planetOrder.map((planetName) => {
      ...
      return /* @__PURE__ */ jsxs("tr", { children: [
        /* @__PURE__ */ jsx("td", { style: { ...cellStyle, width: "24px", textAlign: "center" }, children: /* @__PURE__ */ jsx(PlanetSymbol, { planet: planetName, size: 16, color: isDark ? "#888" : "#666" }) }),
...
function LinkItem({ label, symbol, planetName, onClick, theme, color }) {
  ...
  return /* @__PURE__ */ jsxs(
    "button",
    {
      ...
      children: [
        planetName ? /* @__PURE__ */ jsx(PlanetSymbol, { planet: planetName, size: 14, color: color || (isDark ? "#a8c8f0" : "#2563eb") }) : symbol ? /* @__PURE__ */ jsx("span", { style: { fontSize: "14px" }, children: symbol }) : null,
    ...
    return /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsxs("div", { style: { marginBottom: "1rem" }, children: [
        /* @__PURE__ */ jsxs("div", { style: {
          ...
          /* @__PURE__ */ jsx(PlanetSymbol, { planet: clickedItem.planet, size: 28, color: isDark ? "#fff" : "#333" }),
  ...
  const renderAspectInfo = () => {
    ...
    return /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsxs("div", { style: { marginBottom: "1rem" }, children: [
        ...
        clickedItem.aspectPlanet1 && clickedItem.aspectPlanet2 && /* @__PURE__ */ jsxs("p", { style: { margin: 0, fontSize: "13px", color: isDark ? "#aaa" : "#666", display: "flex", alignItems: "center", gap: "0.25rem" }, children: [
          /* @__PURE__ */ jsx(PlanetSymbol, { planet: clickedItem.aspectPlanet1, size: 13 }),
          /* @__PURE__ */ jsx("span", { children: "-" }),
          /* @__PURE__ */ jsx(PlanetSymbol, { planet: clickedItem.aspectPlanet2, size: 13 })
        ] }),
