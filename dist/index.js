...
function ZodiacWheel({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("g", { className: "zodiac-wheel", children: [
...
function HouseWheel({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("g", { className: `house-wheel ${isSecondChart ? "house-wheel-second" : ""}`, children: sortedHouses.map((house, index) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs("g", { className: `house-division house-${house.house}`, children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        "line",
        {
          x1: outer.x,
      ...
      isSecondChart && index === 0 && /* @__PURE__ */ jsxRuntime.jsx(
        "circle",
        {
          cx: centerX,
          cy: centerY,
...
function PlutoSymbol({ x, y, size, color }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("g", { transform: `translate(${x - size / 2}, ${y - size / 2}) scale(${scale})`, children: [
    /* @__PURE__ */ jsxRuntime.jsx("circle", { cx: "10", cy: "5.5", r: "2.8", fill: "none", stroke: color, strokeWidth: "1.4" }),
    /* @__PURE__ */ jsxRuntime.jsx(
      "path",
      {
    ...
    /* @__PURE__ */ jsxRuntime.jsx("line", { x1: "10", y1: "12", x2: "10", y2: "18.5", stroke: color, strokeWidth: "1.4" }),
    /* @__PURE__ */ jsxRuntime.jsx("line", { x1: "6", y1: "15.5", x2: "14", y2: "15.5", stroke: color, strokeWidth: "1.4" })
  ] });
}
function PlanetDisplay({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("g", { className: `planets ${isOuter ? "outer-planets" : "inner-planets"}`, children: adjustedPlanets.map(({ planet, absoluteDegree, offset }) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      "g",
      {
        ...
        children: [
          ...
          planet.retrograde && /* @__PURE__ */ jsxRuntime.jsx(
            "text",
            {
          ...
          showDegrees && /* @__PURE__ */ jsxRuntime.jsx(
            "text",
            {
              x: degreePos.x,
              y: degreePos.y,
...
function AspectLines({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("g", { className: "aspect-lines", children: [
...
function PlanetProjections({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("g", { className: "planet-projections", children: [
    filteredPlanets.map(
...
function AstroMandala({
  ...
  const ascendantDegree = react.useMemo(() => {
  ...
  const filteredChartAspects = react.useMemo(() => {
  ...
  const filteredSynastryAspects = react.useMemo(() => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "svg",
    {
      ...
      children: [
        ...
        showHouses && chart.houses.length > 0 && /* @__PURE__ */ jsxRuntime.jsx(
          HouseWheel,
          {
            centerX,
            centerY,
...
function ChartInfoPanel({
  ...
  const sortedPlanets1 = react.useMemo(() => sortPlanets(chart.planets), [chart.planets]);
  const sortedPlanets2 = react.useMemo(() => secondChart ? sortPlanets(secondChart.planets) : [], [secondChart]);
  ...
  const renderPosition = (planet, color) => {
    if (!planet) return null;
    return /* @__PURE__ */ jsxRuntime.jsxs("span", { style: { color }, children: [
      /* @__PURE__ */ jsxRuntime.jsx("span", { style: symbolStyle, children: ZODIAC_SYMBOLS[planet.sign] }),
      " ",
      formatDegree2(planet.degree),
      planet.retrograde && /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontSize: "10px", marginLeft: "2px", color: isDark ? "#ff6b6b" : "#c00" }, children: "\u211C" })
    ] });
  };
  const houses1 = react.useMemo(() => [...chart.houses].sort((a, b) => a.house - b.house), [chart.houses]);
  const houses2 = react.useMemo(() => secondChart ? [...secondChart.houses].sort((a, b) => a.house - b.house) : [], [secondChart]);
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { style: containerStyle, className, children: [
    isSynastry && /* @__PURE__ */ jsxRuntime.jsxs("div", { style: {
      display: "flex",
      ...
      /* @__PURE__ */ jsxRuntime.jsx("div", { style: { color: chart1Color, fontWeight: "bold", fontSize: "13px", minWidth: "90px", textAlign: "center" }, children: chart.label || (language === "es" ? "Persona A" : "Person A") }),
      /* @__PURE__ */ jsxRuntime.jsx("div", { style: { color: chart2Color, fontWeight: "bold", fontSize: "13px", minWidth: "90px", textAlign: "center" }, children: secondChart?.label || (language === "es" ? "Persona B" : "Person B") })
    ] }),
    /* @__PURE__ */ jsxRuntime.jsx("table", { style: { width: "100%", borderCollapse: "collapse" }, children: /* @__PURE__ */ jsxRuntime.jsx("tbody", { children: planetOrder.map((planetName) => {
    ...
    showHouses && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      /* @__PURE__ */ jsxRuntime.jsxs("div", { style: sectionTitleStyle, children: [
        language === "es" ? "Casas:" : "Houses:",
        " (Placidus)"
      ] }),
      /* @__PURE__ */ jsxRuntime.jsx("table", { style: { width: "100%", borderCollapse: "collapse" }, children: /* @__PURE__ */ jsxRuntime.jsx("tbody", { children: [1, 4, 7, 10].map((num) => {
        const house1 = houses1.find((h) => h.house === num);
        const house2 = houses2.find((h) => h.house === num);
        const label = getHouseLabel(num);
        return /* @__PURE__ */ jsxRuntime.jsxs("tr", { children: [
          /* @__PURE__ */ jsxRuntime.jsxs("td", { style: { ...cellStyle, fontWeight: "bold", width: "40px" }, children: [
            label,
            ":"
          ] }),
          /* @__PURE__ */ jsxRuntime.jsx("td", { style: { ...cellStyle, color: isSynastry ? chart1Color : isDark ? "#e0e0e0" : "#333" }, children: house1 && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
            /* @__PURE__ */ jsxRuntime.jsx("span", { style: symbolStyle, children: ZODIAC_SYMBOLS[house1.sign] }),
            " ",
            formatDegree2(house1.degree)
          ] }) }),
          isSynastry && /* @__PURE__ */ jsxRuntime.jsx("td", { style: { ...cellStyle, color: chart2Color }, children: house2 && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
            /* @__PURE__ */ jsxRuntime.jsx("span", { style: symbolStyle, children: ZODIAC_SYMBOLS[house2.sign] }),
            " ",
    ...
    showElements && !isSynastry && /* @__PURE__ */ jsxRuntime.jsx(ElementsDisplay, { chart, language, isDark })
  ] });
}
function ElementsDisplay({ chart, language, isDark }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { style: sectionTitleStyle, children: language === "es" ? "Elementos" : "Elements" }),
    /* @__PURE__ */ jsxRuntime.jsx("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.5rem" }, children: Object.entries(elementCounts).map(([element, count]) => /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", alignItems: "center", gap: "0.5rem" }, children: [
      /* @__PURE__ */ jsxRuntime.jsxs("span", { children: [
        count,
        "x"
      ] }),
      /* @__PURE__ */ jsxRuntime.jsx("span", { children: elementEmojis[element] }),
      /* @__PURE__ */ jsxRuntime.jsx("span", { children: elementNames[element] })
    ] }, element)) })
  ] });
}
var signToInfoKey = {
...
function AstroMandalaWithModal({
  ...
  const mandalaContainerRef = react.useRef(null);
  const scrollPositionRef = react.useRef(0);
  const [isMobile, setIsMobile] = react.useState(false);
  const [windowSize, setWindowSize] = react.useState({ width: 600, height: 600 });
  ...
  const [showChartInfo, setShowChartInfo] = react.useState(initialShowChartInfo);
  const modalMandalaSize = react.useMemo(() => {
  ...
  const [showAspects, setShowAspects] = react.useState(initialShowAspects);
  const [showDegrees, setShowDegrees] = react.useState(initialShowDegrees);
  const [showHouses, setShowHouses] = react.useState(initialShowHouses);
  const [showSecondChartHouses, setShowSecondChartHouses] = react.useState(initialShowSecondChartHouses);
  const [showPlanetProjections, setShowPlanetProjections] = react.useState(initialShowPlanetProjections);
  const [showBirthDataOnChart, setShowBirthDataOnChart] = react.useState(initialShowBirthData);
  const [includeAnglesInSynastry, setIncludeAnglesInSynastry] = react.useState(initialIncludeAnglesInSynastry);
  const [theme, setTheme] = react.useState(initialTheme);
  const [language, setLanguage] = react.useState(initialLanguage);
  const downloadChartAsImage = react.useCallback(async () => {
  ...
  const [aspectFilters, setAspectFilters] = react.useState(() => {
    const filters = {};
  ...
  const isDark = theme === "dark";
  const isSynastry = Boolean(secondChart);
  const aspectTypesFilter = react.useMemo(() => {
    return ALL_ASPECT_TYPES.filter((aspect) => aspectFilters[aspect]);
  }, [aspectFilters]);
  const toggleAspectFilter = react.useCallback((aspect) => {
  ...
  const modalContent = isModalOpen && isMounted && portalContainerRef.current ? /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", alignItems: "center", gap: isMobile ? "0.25rem" : "1rem", flexShrink: 1, overflow: "hidden" }, children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsxs(
                  "select",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntime.jsx("option", { value: "en", children: isMobile ? "\u{1F1EC}\u{1F1E7}" : "\u{1F1EC}\u{1F1E7} English" }),
                      /* @__PURE__ */ jsxRuntime.jsx("option", { value: "es", children: isMobile ? "\u{1F1EA}\u{1F1F8}" : "\u{1F1EA}\u{1F1F8} Espa\xF1ol" })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntime.jsx(
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(
          "div",
          {
            ...
            children: [
              showModalSettings && /* @__PURE__ */ jsxRuntime.jsxs(
                "div",
                {
                  style: {
                    width: "280px",
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntime.jsxs("div", { style: sectionStyle, children: [
                      /* @__PURE__ */ jsxRuntime.jsx("h4", { style: { margin: "0 0 0.5rem 0", fontSize: "13px", textTransform: "uppercase", opacity: 0.7 }, children: t.settings }),
                      /* @__PURE__ */ jsxRuntime.jsxs("label", { style: checkboxLabelStyle, children: [
                        /* @__PURE__ */ jsxRuntime.jsx(
                          "input",
                          {
                            type: "checkbox",
                      ...
                      isSynastry && /* @__PURE__ */ jsxRuntime.jsxs("label", { style: checkboxLabelStyle, children: [
                        /* @__PURE__ */ jsxRuntime.jsx(
                          "input",
                          {
                            type: "checkbox",
                      ...
                      (birthData || secondBirthData) && /* @__PURE__ */ jsxRuntime.jsxs("label", { style: checkboxLabelStyle, children: [
                        /* @__PURE__ */ jsxRuntime.jsx(
                          "input",
                          {
                            type: "checkbox",
                      ...
                      isSynastry && showAspects && /* @__PURE__ */ jsxRuntime.jsxs("label", { style: checkboxLabelStyle, children: [
                        /* @__PURE__ */ jsxRuntime.jsx(
                          "input",
                          {
                            type: "checkbox",
                    ...
                    showAspects && /* @__PURE__ */ jsxRuntime.jsxs("div", { style: sectionStyle, children: [
                      /* @__PURE__ */ jsxRuntime.jsx("h4", { style: { margin: "0 0 0.5rem 0", fontSize: "13px", textTransform: "uppercase", opacity: 0.7 }, children: t.aspectTypes }),
                      /* @__PURE__ */ jsxRuntime.jsx("div", { style: { marginBottom: "0.5rem" }, children: /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontSize: "12px", opacity: 0.6 }, children: t.majorAspects }) }),
                      MAJOR_ASPECTS.map((aspect) => /* @__PURE__ */ jsxRuntime.jsxs("label", { style: { ...checkboxLabelStyle, fontSize: "13px" }, children: [
                        /* @__PURE__ */ jsxRuntime.jsx(
                          "input",
                          {
                            type: "checkbox",
                      ...
                      /* @__PURE__ */ jsxRuntime.jsx("div", { style: { marginTop: "0.75rem", marginBottom: "0.5rem" }, children: /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontSize: "12px", opacity: 0.6 }, children: t.minorAspects }) }),
                      ALL_ASPECT_TYPES.filter((a) => !MAJOR_ASPECTS.includes(a)).map((aspect) => /* @__PURE__ */ jsxRuntime.jsxs("label", { style: { ...checkboxLabelStyle, fontSize: "13px" }, children: [
                        /* @__PURE__ */ jsxRuntime.jsx(
                          "input",
                          {
                            type: "checkbox",
                    ...
                    /* @__PURE__ */ jsxRuntime.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          ...
                          showBirthDataOnChart && (birthData || secondBirthData) && /* @__PURE__ */ jsxRuntime.jsxs("div", { style: {
                            textAlign: "center",
                            color: isDark ? "#e0e0e0" : "#333",
                            ...
                            birthData && /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { marginBottom: secondBirthData ? "0.5rem" : 0, color: innerChartColor }, children: [
                              birthData.name && /* @__PURE__ */ jsxRuntime.jsx("div", { style: { fontWeight: 600 }, children: birthData.name }),
                              (birthData.date || birthData.time) && /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
                                birthData.date,
                                birthData.time ? ` - ${birthData.time}` : ""
                              ] }),
                              birthData.location && /* @__PURE__ */ jsxRuntime.jsx("div", { children: birthData.location })
                            ] }),
                            secondBirthData && /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { color: outerChartColor }, children: [
                              secondBirthData.name && /* @__PURE__ */ jsxRuntime.jsx("div", { style: { fontWeight: 600 }, children: secondBirthData.name }),
                              (secondBirthData.date || secondBirthData.time) && /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
                                secondBirthData.date,
                                secondBirthData.time ? ` - ${secondBirthData.time}` : ""
                              ] }),
                              secondBirthData.location && /* @__PURE__ */ jsxRuntime.jsx("div", { children: secondBirthData.location })
                            ] })
                          ] })
                        ]
                      }
                    ),
                    showChartInfo && !isMobile && chartInfoPosition === "right" && /* @__PURE__ */ jsxRuntime.jsx("div", { style: {
                      alignSelf: "center",
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { position: "relative", display: "inline-block" }, className, children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(AstroMandala, { ...mainMandalaProps, size })
    ] }),
    modalContent && portalContainerRef.current && reactDom.createPortal(modalContent, portalContainerRef.current)
  ] });
}

exports.ASPECT_ANGLES = ASPECT_ANGLES;
exports.AspectLines = AspectLines;
exports.AstroMandala = AstroMandala;
exports.AstroMandalaWithModal = AstroMandalaWithModal;
exports.DEFAULT_ASPECT_COLORS = DEFAULT_ASPECT_COLORS;
exports.DEFAULT_ORBS = DEFAULT_ORBS;
exports.ELEMENT_COLORS = ELEMENT_COLORS;
exports.HouseWheel = HouseWheel;
exports.PLANET_CATEGORIES = PLANET_CATEGORIES;
exports.PLANET_SYMBOLS = PLANET_SYMBOLS;
exports.PlanetDisplay = PlanetDisplay;
exports.SIGN_ELEMENTS = SIGN_ELEMENTS;
exports.SIGN_START_DEGREES = SIGN_START_DEGREES;
exports.TRANSLATIONS = TRANSLATIONS;
exports.ZODIAC_ORDER = ZODIAC_ORDER;
exports.ZODIAC_SYMBOLS = ZODIAC_SYMBOLS;
exports.ZodiacWheel = ZodiacWheel;
exports.calculateNatalAspects = calculateNatalAspects;
exports.calculateSynastryAspects = calculateSynastryAspects;
exports.convertHoroscopeToChart = convertHoroscopeToChart;
exports.formatDegree = formatDegree;
exports.getAbsoluteDegree = getAbsoluteDegree;
exports.getMandalaAngle = getMandalaAngle;
exports.getOrbForPlanets = getOrbForPlanets;
exports.getPlanetAbsoluteDegree = getPlanetAbsoluteDegree;
